...
class CMW(GenericInstrument):
    ...
    def arb_file(self, standard="11n"):
        # standard dict
        STANDARD = {
            "11n": "\"D:\\aic_wave\\aic_wave_ydy\\11n_40m_64qam.wv\"",
            "11ac": "\"D:\\aic_wave\\aic_wave_ydy\\11ac_40m_256qam.wv\"",
            "11ax": "\"D:\\aic_wave\\aic_wave_ydy\\11ax_40m_1024qam.wv\"",
            "DH1": "\"D:\\aic_wave\\cmw_bt\\bt1m_dh1_PN9.wv\"",
            "3DH5": "\"D:\\aic_wave\\cmw_bt\\bt3m_dh5_PN9.wv\"",
            "BLE1M": "\"D:\\aic_wave\\cmw_bt\\le1m_255B_PN9.wv\""
        }
    ...
    def sge_cw_pwr_atten(self,att=0):
        self.write("SOURce:GPRF:GEN:RFSettings:EATTenuation "+str(att))
        return True
    ...
    def wlan_meas_start(self):
        self.write("CONFigure:WLAN:MEAS1:MEValuation:SCOunt:MODulation 1")
        time.sleep(0.1)
...
if __name__ == "__main__":
    ...
    # CMW1.sge_cw_mode("RF1C")
    # CMW1.sge_cw_set_power(-30)
    # CMW1.sge_cw_set_cfreq(2412)
    # CMW1.sge_cw_pwr_off()
    # CMW1.sge_cw_pwr_atten(0)
    # CMW1.sge_cw_pwr_on()
    ...
    time.sleep(1)
    ms_list = CMW1.query('FETCh:GPRF:MEAS:SPECtrum:REFMarker:SPEak? MAXPeak, AVERage').strip()
    ...
    # """
    CMW1.wlan_set_route()
    CMW1.wlan_set_freq(2442e+6)
    CMW1.wlan_set_peakpwr(30)
    CMW1.wlan_set_standard("11ax")
