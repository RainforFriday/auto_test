...
class CMW(GenericInstrument):
    ...
    def wlan_set_route(self, route="RF1C"):
        self.write("ROUTe:WLAN:MEAS1:SCENario:SALone {}, RX1".format(route))
        return True
    ...
    def wlan_meas_start(self,num=100):
        self.write("INITiate:WLAN:MEAS1:MEValuation")
        self.write("CONFigure:WLAN:MEAS1:MEValuation:SCOunt:MODulation "+str(num))
        return True
