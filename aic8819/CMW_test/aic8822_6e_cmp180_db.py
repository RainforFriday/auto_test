...
if __name__ == "__main__":
    ...
    xlsx_path = r'.\table\cmp_TABLE_8822_6e.xlsx'
    current_time = datetime.datetime.now().strftime("%m%d_%H%M%S")

    file_path = r'.\data\cmp_8822_6e_v1_data_'+current_time+'.xlsx'
    data_dict = {}
    ...
    bin_file = "testmode_8822_929_6e.bin"
    ...
    for linex in table_lines:
        ...
        for setchx in db_line.l_setch_ucmd():
            ...
            UARTX.sendcmd(f"setbandchan 2 {ch}")
