...
def volt_ms_start(enable_filt=1, case=TestCases.TxHB.value, block=Blocks.DTMX.value):
    """
    Modify the table directly without filtering, and then measure all items;
    Recommend using filtering！
...
if __name__ == "__main__":
    ...
    file_path = r'.\data\msadc_data_pa_' + current_time + '.xlsx'

    volt_ms_start(enable_filt=1, case=TestCases.TxHB.value, block=Blocks.PA.value)
