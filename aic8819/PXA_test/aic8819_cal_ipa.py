...
if __name__ == "__main__":
    ...
    apc_reg.fix_apc_high_table_gain()   # ac
    ...
    msadc0.testmux(2, 6)    #test mode ,bit
    ...
    apc_reg.set_pa_hb_gain_en(2)    # pa_hb_gain_en  10
    cal_ipa_vofst = volt_ms_robust_avg(3)
    print(f'offset_volt:  {cal_ipa_vofst}')

    apc_reg.set_pa_hb_gain_en(3)    # pa_hb_gain_en  11
    ...
    apc_reg.set_pa_hb_gain_en(0)    # pa_hb_gain_en  10
    ...
    # fix apc high_rate index_c
    # tone_on 0 0, tone_amp = 0
    # msadc initial
    # isense_config (isense_en = 1, isense_rbit = 4)
    # test_port_config (test_mode=3, test_bit= , pa_test_enable=1)
    # pa_hb_gain_en_dr=1, and set pa_hb_gain_en = 0
    # cal_ipa_vofst = volt_ms_avg(3)
    # pa_hb_gain_en_dr=1, and set pa_hb_gain_en = 1
    #  cal_ipa_v = volt_ms_avg(3)
    #  cal_ipa_init = (cal_ipa_v - cal_ipa_vofst)/res0
    #  if cal_ipa_init < itgt:
    #      cal_ipa_sign = 1
    #  elif cal_ipa_init > itgt:
    #      cal_ipa_sign = -1
    #  else:
    #      cal_ipa_sign = 0
    #  cal_ipa_ref = cal_ipa_init
    #  cal_ipa_reg_ofst = 0
    #  cal_ipa_reg_def = 32
    #  if cal_ipa_sign == 0:
    ...
    #
    #  release apc
    #  isense_en = 0, isense_rbit=4
    #  pa_test_enable = 0, test_bit=0, test_mode=0
    #  pa_hb_gain_en_dr = 0
    #  pa_hb_gain_en_reg = 0
