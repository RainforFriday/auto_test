...
class MSADC:
    ...
    def basiconfig(self):
        ...
        #print(UARTc.read_reg("40100038"))
        #print(UARTc.read_reg("4010d008"))
        #time.sleep(0.1)
        UARTc.write_reg_mask("4010d008", "27:16", self.Window)
        #print(UARTc.read_reg("4010d00c"))
        #time.sleep(0.1)
    ...
    def set_se_p_mode(self):
        ...
        UARTc.write_reg_mask("4010d00c", "11",0)
        UARTc.write_reg_mask("4010d00c", "0", 1)
        time.sleep(0.01)
        #print(UARTc.read_reg("4010d00C"))
    ...
    def input_sel_testport_usb_on(self):
    ...
    def measure(self):
        UARTc.sendcmd("w 4010d004 1")
        #UARTc.sendcmd("w 4010d004 1")# start
    ...
    def ms_portdc_usb_on(self):
        self.basiconfig()
        self.adconfig()
        self.input_sel_testport_usb_on()
        v_portdc = self.ms_volt()
        return v_portdc * 1000.0
...
if __name__ == "__main__":
    ...
    #i_pa = msadcx.ms_pa5g_current()
    #print("i_pa_5g   : " + str(i_pa) + " mA")

    #UARTc.write_reg_mask("40344088", "20:19", 3)
    #vref_wfadc = msadcx.ms_wfadcvref()
    #UARTc.write_reg_mask("40344088", "20:19", 1)

    # i_pa = msadcx.ms_pa24g_current()
    # print("i_pa_24g  : " + str(i_pa) + " mA")
    #print("Vref_wfadc : " + str(vref_wfadc) + "mV")
