...
class SpecTable:
    ...
    def read_table(self):
        ...
        with open(self.spec_path) as SPEC_FILE:
            for net_line in SPEC_FILE.readlines()[1:]:
    ...
    def db_nets_by_block(self, block_sel):
        ...
        for net_line in self.read_table():
            db_net = DCNet(net_line)
            if db_net.block in l_block_sel:
                l_db_nets.append(db_net)
        return l_db_nets
...
if __name__ == "__main__":
    spec_path_aic = "./aic8822/aic8822_spec_testability_20240603.csv"
    spec_path = "./aic8822/aic8822_spec_testability.csv"
